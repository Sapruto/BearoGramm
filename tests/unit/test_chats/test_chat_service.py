...
class TestChatService:
    @pytest.mark.asyncio
    async def test_chat_exists_true(self, chat_service, chat_repository, sample_chat_entity):
    ...
    @pytest.mark.asyncio
    async def test_user_in_chat_true(self, chat_service, chat_repository, sample_chat_entity):
        chat_repository.get_by_id = AsyncMock(return_value=sample_chat_entity)
        user = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_user_in_chat_false(self, chat_service, chat_repository, sample_chat_entity):
        chat_repository.get_by_id = AsyncMock(return_value=sample_chat_entity)
        user = MagicMock()
        user.uuid = str(uuid4())
    ...
    @pytest.mark.asyncio
    async def test_user_in_chat_with_access_get_user_uuid(self, chat_service, chat_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_chat_success(self, chat_service, chat_repository, sample_chat_entity):
        chat_repository.get_by_id = AsyncMock(return_value=sample_chat_entity)
