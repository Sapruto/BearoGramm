...
class PushClientAPI:
    ...
    async def send_push_notification(self, phone_number: str, title: str = "", body: str = "", data: Optional[Dict[str, Any]] = None) -> bool:
        try:
            if data is None:
                data = {}
    ...
    async def send_call_push(self, phone_number: str, caller_uuid: str, caller_name: str = "caller_name", room_id: Optional[str] = None) -> bool:
        data = {
